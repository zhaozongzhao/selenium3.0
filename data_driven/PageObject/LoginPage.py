...
if __name__ == '__main__':
     ...
     driver.switch_to.frame(login.getFrame())
     time.sleep(2)
     login.getclick().click()
     login.getUserName().send_keys('3031371046')
     login.getPassword().send_keys('zzz284117')
     login.getLoginButton().click()
     driver.switch_to.default_content()  # 切换到最上层
     time.sleep(5)
     assert '退出' in driver.page_source, '没有找到元素'
